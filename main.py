...
add_item_to_inventory("Banana Peel", 1)

add_item_to_inventory("Thunder Hammer", 1)
add_item_to_inventory("Spaghetti Whip", 1)
add_item_to_inventory("Magic Yo-Yo", 1)
add_item_to_inventory("Bubble Blower", 1)
add_item_to_inventory("Squeaky Hammer", 1)
add_item_to_inventory("Blanket", 1)  # add a cast message
